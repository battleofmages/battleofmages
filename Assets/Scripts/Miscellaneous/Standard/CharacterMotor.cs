...
public class CharacterMotor : MonoBehaviour
{
    ...
    public Vector3 inputMoveDirection = Cache.vector3Zero;
    ...
    public class CharacterMotorMovement
    {
        ...
        [System.NonSerialized]
        public Vector3 frameVelocity = Cache.vector3Zero;

        [System.NonSerialized]
        public Vector3 hitPoint = Cache.vector3Zero;
    ...
    [System.NonSerialized]
    public Vector3 groundNormal = Cache.vector3Zero;

    private Vector3 lastGroundNormal = Cache.vector3Zero;
    ...
    private void UpdateFunction()
    {
        ...
        Vector3 moveDistance = Cache.vector3Zero;
        if(MoveWithPlatform())
        {
            Vector3 newGlobalPoint = movingPlatform.activePlatform.TransformPoint(movingPlatform.activeLocalPoint);
            moveDistance = (newGlobalPoint - movingPlatform.activeGlobalPoint);
            if(moveDistance != Cache.vector3Zero)
        ...
        groundNormal = Cache.vector3Zero;
        ...
        if(oldHVelocity == Cache.vector3Zero)
        {
    ...
    void FixedUpdate()
    {
        if(movingPlatform.enabled)
        {
            ...
            {
                movingPlatform.platformVelocity = Cache.vector3Zero;
            }
        }
    ...
    {
        if(!canControl)
            inputMoveDirection = Cache.vector3Zero;
    ...
    void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        {
            if((hit.point - movement.lastHitPoint).sqrMagnitude > 0.001 || lastGroundNormal == Cache.vector3Zero)
            ...
            movement.frameVelocity = Cache.vector3Zero;
        }
    }
    ...
    {
        if(desiredMovementDirection == Cache.vector3Zero)
            return 0;
        else
        {
