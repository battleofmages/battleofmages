...
namespace BoM.UI.Lobby {
	...
	public class Login : SingletonMonoBehaviour<Login>, Initializable {
		...
		// LogOut
		public void LogOut() {
			uLobby.Lobby.RPC("AccountLogOut", uLobby.Lobby.lobby);
		}
		...
		public void SendEncryptedLoginRequest(string email, string encryptedPassword) {
			...
			// Login RPC
			uLobby.Lobby.RPC("AccountLogIn", uLobby.Lobby.lobby, email, encryptedPassword, SystemInfo.deviceUniqueIdentifier);
		}
